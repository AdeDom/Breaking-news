...
class GeneralDaoTest {
    ...
    @Test
    fun getGeneralFlow() = runBlocking {
        ...
        dao.saveGeneral(generalEntity)

        val result = dao.getGeneralFlow().asLiveData().getOrAwaitValue()

        assertThat(result).isEqualTo(listOf(generalEntity))
    }
